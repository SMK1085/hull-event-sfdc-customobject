...
const fetchFieldsUnique = (req: Request, res: Response) => {
    ...
    return cache.wrap(`fieldsUnique_${objType}`, () => {
        return agent.listFieldsUnique(objType);
    })
    .then((fields: Field[]) => {
...
export default fetchFieldsUnique;