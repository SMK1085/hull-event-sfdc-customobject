...
const fetchFieldsReference = (req: Request, res: Response) => {
    ...
    return cache.wrap(`fieldsReference_${objType}`, () => {
        return agent.listFieldsReference(objType);
    })
    .then((fields: Field[]) => {
...
export default fetchFieldsReference;